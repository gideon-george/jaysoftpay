      ...
      <div class="min-h-screen h-full flex flex-col justify-center">
        ...
        <div class="px-5 sm:px-6">
          <div class="w-full max-w-md mx-auto">
            ...
            <h1 class="h2 font-playfair-display text-slate-800 mb-12">Sign in to Jaysoftpay</h1>
      ...
      <div class="min-h-screen h-full flex flex-col justify-center">
        <div class="px-5 sm:px-6">
          <div class="w-full max-w-lg mx-auto">
            <h2 class="h3 md:text-4xl font-playfair-display text-slate-100 mb-4"> Jaysoftpay Inc.</h2>
            <div class="space-y-3">
              ...
              <blockquote class="text-slate-400 italic">The best payment solution of the 21st century.</blockquote>
            </div>
