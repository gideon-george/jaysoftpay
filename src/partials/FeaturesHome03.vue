    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <h2 class="h2 font-playfair-display text-slate-100">Simplify operations and grow your business with Jaysoftpay</h2>
        </div>
        ...
        <div class="max-w-sm mx-auto md:max-w-none grid gap-12 md:grid-cols-3 md:gap-x-10 md:gap-y-10 items-start">
          ...
          <article data-aos="fade-up">
            ...
            <h3 class="h4 font-playfair-display mb-2">
              <router-link class="text-slate-800 hover:underline hover:decoration-blue-100" to="#0">Debit and Credit Cards</router-link>
            </h3>
            <p class="text-lg text-slate-500">We make it easier for you to focus on building great products while we work on simplifying your payments. Focus on your business while we handle the complexities of payments for you</p>
          </article>
          ...
          <article data-aos="fade-up" data-aos-delay="100">
            ...
            <h3 class="h4 font-playfair-display mb-2">
              <router-link class="text-slate-800 hover:underline hover:decoration-blue-100" to="#0">POS (Point Of Sale) </router-link>
            </h3>
            <p class="text-lg text-slate-500">We make it easier for you to focus on building great products while we work on simplifying your payments. Focus on your business while we handle the complexities of payments for you.</p>
          </article>
          ...
          <article data-aos="fade-up" data-aos-delay="200">
            ...
            <h3 class="h4 font-playfair-display mb-2">
              <router-link class="text-slate-800 hover:underline hover:decoration-blue-100" to="#0">Online (Website & Mobile) </router-link>
            </h3>
            <p class="text-lg text-slate-500">We make it easier for you to focus on building great products while we work on simplifying your payments. Focus on your business while we handle the complexities of payments for you.</p>
          </article>
