      ...
      <div class="py-12 md:py-20">
        ...
        <div class="relative max-w-sm mx-auto grid gap-16 md:grid-cols-2 lg:grid-cols-3 lg:gap-y-20 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
          ...
          <div class="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
            ...
            <h3 class="h4 font-playfair-display mb-2">Payment Links</h3>
            <p class="text-lg text-slate-500">Share payment link via an email, SMS, messenger, chatbot etc and get paid immediately.</p>
            <div><router-link class=" font-bold text-blue-600 hover:text-blue-700 inline-block group rounded" to="/request-demo">Know More ></router-link></div>
          </div>
          ...
          <div class="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="100">
            <svg class="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
             ...
             <h3 class="h4 font-playfair-display mb-2">Payment Pages</h3>
            <p class="text-lg text-slate-500">Take your store online instantly with zero coding. Accept international & domestic Payments.</p>
            <div><router-link class=" font-bold text-blue-600 hover:text-blue-700 inline-block group rounded" to="/request-demo">Know More ></router-link></div>
          </div>
          <!-- 3rd item -->
          <div class="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="200">
            <svg class="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
             ...
             <h3 class="h4 font-playfair-display mb-2">Payment Buttons</h3>
            <p class="text-lg text-slate-500">Create, Copy & Collect With Payment Button. Collect one time or subsription payments & more.</p>
            <div><router-link class=" font-bold text-blue-600 hover:text-blue-700 inline-block group rounded" to="/request-demo">Know More ></router-link></div>
          </div>
          ...
          <div class="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="300">
            ...
            <h3 class="h4 font-playfair-display mb-2">Subscriptions</h3>
            <p class="text-lg text-slate-500"> Subscription plans with automated recurring transactions on various payment modes.</p>
          </div>
          ...
          <div class="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="400">
            <svg class="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
             ...
             <h3 class="h4 font-playfair-display mb-2">Route</h3>
            <p class="text-lg text-slate-500">Split incoming payments automatically to vendor's accounts, manage marketplace money flow...</p>
            <div><router-link class=" font-bold text-blue-600 hover:text-blue-700 inline-block group rounded" to="/request-demo">Know More ></router-link></div>
          </div>
          ...
          <div class="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="500">
            ...
            <h3 class="h4 font-playfair-display mb-2">Smart Collect</h3>
            <p class="text-lg text-slate-500">automatically reconcile incoming NEFT, RTGS, IMPS, UPI payments using Virtual Accounts & UPI-IDs</p>
            <div><router-link class=" font-bold text-blue-600 hover:text-blue-700 inline-block group rounded" to="/request-demo">Know More ></router-link></div>
          </div>
