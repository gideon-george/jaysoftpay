    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="relative max-w-3xl mx-auto text-center">
          ...
          <div class="relative">
            <h2 class="h2 font-playfair-display text-slate-800 mb-4">The easiest way to make and accept payments from customers. <span class="text-emerald-500">anywhere in the world. </span>.</h2>
            <p class="text-xl text-slate-500 mb-8">Get started now to grow your business.
Create an account or get in touch with us.</p>
            <div>
